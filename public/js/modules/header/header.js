...
function headerBackgroundScroll() {
	const scrollPos = 0,
		...
		headerHamburgerIcon = document.querySelector(".header__hamburger svg"),
		headerLogo = document.getElementsByClassName(
			"a7a2a367-2ac2-4252-9aa9-a4bc92e07ffb"
		)
	...
	window.addEventListener("scroll", () => {
		...
		if (windowYOffset > scrollPos) {
			...
			headerHamburgerIcon.classList.add("header__hamburger--blue")
			headerLogo[0].classList.add("header__logo__svg--blue")
			...
			headerLogo[0].classList.remove("header__logo__svg--blue")
		}
	})
}
